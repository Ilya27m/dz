    ...
    */
    ...
    public static class Person {
        ...
        void takeDamage(Integer damage) throws Exception {
            int newHealth;
            System.out.println(newHealth = health - (damage - protection));
            if (damage <= 0) throw new Exception();
            if (health <= 0) throw new PersonDead("PersonDead");
            if (newHealth <= 0) throw new PersonDead("PersonDead");
    ...
    public static class Mage extends Person {
        ...
        int health = 100;
        int protection = 15;
        public Mage(String name, int health, int protection) {
            super(name, 100, 15);
        }
        ...
        void takeDamage(Integer damage) throws Exception {
            int newHealth;
            System.out.println(newHealth = (health - (damage - protection - health % 10)));
            if (damage <= 0) throw new Exception();
            if (health <= 0) throw new PersonDead("PersonDead");
            if (newHealth <= 0) throw new PersonDead("PersonDead");
            this.health = newHealth;
    ...
    public static class Archer extends Person {
        ...
        public Archer(String name, int health, int protection) {
            super(name, 120, 12);
        }
        public int getHealth() {
            return health;
        ...
        @Override
        String announce() {
            return "Archer " + this.name + " имеет характеристики: " + health + " здоровья и " + protection + "защиты";
        }
